  ...
  return (
    <section id="philosophy" className="py-32 px-6 bg-[#fdfbf7]">
      <div className="container mx-auto max-w-4xl text-center">
        <h2 className="font-display text-4xl md:text-5xl text-[#1a1815] leading-tight mb-10">
          We’re rethinking travel. <br />
          Your intelligent companion offering insight, precision, and serendipity.
        </h2>
        <p className="text-lg text-[#3a3530] leading-relaxed mb-8 max-w-3xl mx-auto font-light">
        ...
        <p className="text-lg text-[#3a3530] leading-relaxed mb-12 max-w-3xl mx-auto font-light">
        ...
        <button className="text-[#8a7b63] uppercase tracking-widest font-mono text-sm border-b border-[#8a7b63] pb-1 hover:text-[#6a6155] hover:border-[#6a6155] transition-colors">
